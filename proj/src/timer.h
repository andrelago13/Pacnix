...
/**
 * @brief Waits for x*60 timer0 interrupts
 *
 * Uses the timer0 interrupt cycle to wait for x*60 interrupts
 *
 * @param x Number of seconds to "wait"
 * @return Return 0 upon success and non-zero otherwise
 */
 ...
 *
 * Unsubscribes timer 0 interrupts to hook specified
 *
 * @param hook address of irq_hook to unsubcribe timer interrupts
 * @return Return 0 upon success and non-zero otherwise
 */
 ...
 *
 * Subscribes timer 0 interrupts to hook specified
 *
 * @param hook address of irq_hook to assign timer interrupts
 * @return Return 0 upon success and non-zero otherwise
 */
